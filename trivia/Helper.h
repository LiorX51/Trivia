...
enum MessageType : byte
{
	...
	MT_CLIENT_CLIENT_UPDATE = 204,
	MT_CLIENT_FINISH = 207,
	MT_CLIENT_EXIT = 208,
	MT_SERVER_CLIENT_UPDATE = 101,
};
...
public:
	...
	static void send_CLIENT_UPDATE_message_to_client(SOCKET sc, const std::string& file_content, const std::string& second_username, const std::string& all_users);
